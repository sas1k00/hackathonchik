...
**Модель монетизации** (гипотезы, которые нужно проверить интервью, см. `docs/validation-plan.md`):
- **B2C freemium:** диагностика бесплатна; платно — расширенные банки (геометрия, тригонометрия) и повторная диагностика.
- **B2B для учебных центров:** входная диагностика новых учеников и панель учителя по подписке за группу.
- **Школы:** бесплатно для учителя, чтобы получить охват; платные — аналитика по параллели и выгрузки.

  ...
  function viewHome() {
    ...
    app.innerHTML = `
      <section class="hero">
        ...
        <p class="lead">Tamyr находит не просто тему, где ученик ошибается, а <b>корневой пробел</b>, из-за которого рушатся все следующие темы. Вглубь он спускается только там, где ученик ошибается: без пробелов хватает около 10 вопросов. Затем строит короткий план — от корня наверх.</p>
        <div class="cta">
  ...
  function viewSetup() {
    app.innerHTML = `
      <section class="card narrow">
        <h1>Диагностика</h1>
        <p class="muted">От нескольких вопросов до 40 — чем больше пробелов, тем глубже спускаемся. Калькулятор не нужен, черновик пригодится. Если не знаете ответ — нажмите «Не знаю»: угадывание делает карту менее точной.</p>
        <form id="setup-form">
